...
train_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/NIPSDB/SCSZ/YN-tuomin/Merge",
    ann_file="/media/Storage3/wlw/NIPSDB/SCSZ/YN-tuomin/Merge/CRL_train.json",
    transforms=presets.detr,  # see transforms/presets to choose a transform
    train=True,
)
test_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/NIPSDB/SCSZ/YN-tuomin/Merge",
    ann_file="/media/Storage3/wlw/NIPSDB/SCSZ/YN-tuomin/Merge/CRL_test.json",
