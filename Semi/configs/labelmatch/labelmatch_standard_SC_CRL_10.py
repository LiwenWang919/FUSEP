...
classes = ('MAX', 'MAN', 'MAN_DOT', 'MAN_STR', 'LV', 'HD', 'GEN', 'THX', 'ABD', 'BUTT', 'RHOM', 'DIEN', 'NT', 'NAS', 'NB')
dataset_type = 'CocoDataset'
data_root = '/media/Storage3/wlw/NIPSDB/SCSZ/SC-tuomin-hou-anno/'
ann_root = '/media/Storage3/wlw/NIPSDB/SCSZ/SC-tuomin-hou-anno/'
data = dict(
    ...
    train=dict(
        type='SemiDataset', 
        classes=classes,
        ann_file=ann_root + 'CRL_train_label_10.json',
        ann_file_u=ann_root + 'CRL_train_unlabel_10.json',
    ...
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=ann_root + 'CRL_test.json',
