...
class Trainer():
    def __init__(self, opt):
        if opt.part == 'heart':
            ...
            opt.n_class = 5
        elif opt.part == 'mmwhs' or opt.part == 'CHAOS':
            opt.n_class = 5
        elif opt.part == 'spine':
            opt.n_class = 7
    ...
    def save(self, save_optimizer=False, save_path=None, **kwargs):
        ...
        if save_path is None:
            ...
            save_path = f'ckp_abl/res101pre_gpu{self.opt.local_rank}_{self.opt.part}_{self.opt.selected_source_hospital}-{self.opt.selected_target_hospital}_{timestr}'
