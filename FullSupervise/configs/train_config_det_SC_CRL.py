...
train_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/NIPSDB/SCSZ/SC-tuomin-hou-anno",
    ann_file="/media/Storage3/wlw/NIPSDB/SCSZ/SC-tuomin-hou-anno/CRL_train.json",
    transforms=presets.detr,  # see transforms/presets to choose a transform
    train=True,
)
test_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/NIPSDB/SCSZ/SC-tuomin-hou-anno",
    ann_file="/media/Storage3/wlw/NIPSDB/SCSZ/SC-tuomin-hou-anno/CRL_test.json",
