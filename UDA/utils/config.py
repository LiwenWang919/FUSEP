...
class Config:
    ...
    batch_size = 6
    load_path = None #'checkpoints/res101pre_heart_c1-c2_05240504_0.7378_bce'
    part = 'CRL' #  heart, head, cardiac, spine, abdomen, EP, 4cc, 3vt, CHAOS, CRL
    selected_source_hospital = 'SC'
    selected_target_hospital = 'SZ'
    # heart & head -> c1 or c2
    # cardiac -> Site_G or Site_R
    # mmwhs -> mr or ct
    # spine & abdomen -> GE PH & SA
    # EP -> ours & public
    # FCS -> A & B
    ...
    dataset_path_spine = 'dataset/spine'
    dataset_path_abdo = 'dataset/abdomen'
    dataset_path_ep = 'dataset/EP'
    dataset_path_4cc = 'dataset/FCS/4CC'
    dataset_path_3vt = 'dataset/FCS/3VT'
    dataset_path_chaos = 'dataset/CHAOS'
    dataset_path_crl = '/media/Storage1/Lvxg/mmwhs/CRL'
    ...
    train_min_size = (600,)
    train_max_size = 800 #d:1000; head2-1 suggests 800
    test_min_size = 800
    test_max_size = 1000
