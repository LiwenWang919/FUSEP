...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data-dir', type=str, default='/media/Storage1/wlw/Semi/SSOD/fetus_annotations_coco/4c/c1/test/annotation.json', help='json path')
    parser.add_argument('-s', '--save-path', type=str, default='/media/Storage1/wlw/Semi/SSOD/voc/4C/c1/test', help='xml save path')
    ...
    if len(sys.argv) > 1:
        ...
        data_dir = '/media/Storage1/wlw/Semi/SSOD/fetus_annotations_coco/4c/c1/test/annotation.json'
        xml_save_path = '/media/Storage1/wlw/Semi/SSOD/voc/4C/c1/test'
